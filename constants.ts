...
export const BRAND_INTRO = `SANTI bridges the gap between boutique luxury and commercial durability. Our collections are built from premium materials—Long-Staple Cotton Sateen, Eucalyptus Lyocell, and plush Velvet—and constructed to meet the demands of commercial laundry cycles while delivering the guest experience of a five-star property.`;
